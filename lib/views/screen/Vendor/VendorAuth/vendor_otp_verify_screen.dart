...
class VendorOtpVerifyScreen extends StatefulWidget {
  final String email;
  const VendorOtpVerifyScreen({super.key, required this.email});
        ...
        children: [
          ...
          OtpTextField(
            ...
            onSubmit: (String verificationCode) {
              _vendorAuthController.isForgetVerify.value = verificationCode;
            },
          ),
          SizedBox(height: 10),
          Align(
          ...
          Obx(()=>
             CustomButton(
              loading: _vendorAuthController.isVerificationLoading.value,
              onTap: () {
                _vendorAuthController.emailVerifedWithForget(email: widget.email);
              },
              text: "Verify Code",
            ),
          ),
