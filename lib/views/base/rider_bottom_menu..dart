...
class RiderBottomMenu extends StatelessWidget {
  final int menuIndex;

  const RiderBottomMenu(this.menuIndex, {super.key});
          ...
          onTap: (value) {
            switch (value) {
              case 0:
                ...
                break;
              case 1:
                Get.offAndToNamed(AppRoutes.riderTransectionScreen);
                break;
              case 2:
                Get.offAndToNamed(AppRoutes.riderNotificationScreen);
                break;
              case 3:
                Get.offAndToNamed(AppRoutes.riderProfileScreen);
                break;
            }
          },
          items: menuItems,
